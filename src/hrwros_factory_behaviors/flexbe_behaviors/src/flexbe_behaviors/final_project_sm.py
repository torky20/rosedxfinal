	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('Compute pick 2',
										...
										transitions={'continue': 'Activate Gripper 2', 'failed': 'Compute pick 2'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off},
			...
			OperatableStateMachine.add('Deactivate Gripper 1',
										...
										transitions={'continue': 'Move R1 back Home final', 'failed': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off})
			...
			# x:1053 y:677
			OperatableStateMachine.add('Move R1 back Home final',
										flexbe_manipulation_states__SrdfStateToMoveit(config_name='R1Home', move_group=pick1_group, action_topic='/move_group', robot_name=''),
			...
			OperatableStateMachine.add('Move R2 to pick',
										...
										transitions={'reached': 'Move R2 back to Home_2', 'planning_failed': 'failed', 'control_failed': 'Activate Gripper 2'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off},
